...
async function getFleets() {
  try {
    const storage = await chrome.storage.local.get("CURRENT_USER_ID");
    const CURRENT_USER_ID = storage.CURRENT_USER_ID;
    ...
    for (const mission of missions) {
      if (CURRENT_USER_ID && String(CURRENT_USER_ID) === String(mission.owner_pseudo)) continue;
